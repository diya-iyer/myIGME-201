...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
             ...
             * 1. Increase the size of the form by changing:
               ...
               4. Add a GroupBox control to the form: done
                        (Name): genderGroupBox 
                        Text: Gender
                        Size: 90,90
                        Location: 454, 53
            ...
            */
            ...
            {
                if (person.eGender.ToString().Equals("him"))
                {
                    this.himRadioButton.Checked = true;
                }
                else if (person.eGender.ToString().Equals("her"))
                {
            ...
            {
                Student student = (Student)person;
                if (student.eCollegeYear.ToString().Equals("freshman"))
                {
                    this.froshRadioButton.Checked = true;
                }
                else if (student.eCollegeYear.ToString().Equals("sophomore"))
                {
                    this.sophRadioButton.Checked = true;
                }
                else if (student.eCollegeYear.ToString().Equals("junior"))
                {
        ...
        private void ClassRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (rb.Checked)
            {
                if (rb.Name == "seniorRadioButton")
                {
                    this.classOfLabel.Text = "Class of 2023";
                }
                else if (rb.Name == "juniorRadioButton")
                {
                    this.classOfLabel.Text = "Class of 2024";
                }
                else if (rb.Name == "sophRadioButton")
                {
                    this.classOfLabel.Text = "Class of 2025";
                }
                else if (rb.Name == "froshRadioButton")
                {
