    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            LinkedListNode<object> linkedListNode;
            string[] s = {
            "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like",
            "a", "room", "without", "a", "roof",
            "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like",
            "sadness", "is", "the", "truth", "sad" };
            ...
            // 4. Your code here
            linkedListNode = linkedList.Find("Because");
            while (linkedListNode != null)
            {
                linkedListNode = linkedListNode.Next;
                if ((string)linkedListNode.Value == "sad")
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            linkedList.Remove(linkedList.Find("in"));
            linkedList.Remove(linkedList.Find("plain"));
            linkedList.Remove(linkedList.Find("on"));
            linkedList.Remove(linkedList.Find("the"));

            LinkedListNode<object> newNode1 = new LinkedListNode<object>("rain");
            linkedList.AddAfter(linkedListNode1, newNode1);

            LinkedListNode<object> newNode2 = new LinkedListNode<object>("in");
            linkedList.AddAfter(newNode1, newNode2);

            LinkedListNode<object> newNode3 = new LinkedListNode<object>("falls");
            linkedList.AddBefore(linkedListNode2, newNode3);

            LinkedListNode<object> newNode4 = new LinkedListNode<object>("on");
            linkedList.AddAfter(linkedListNode2, newNode4);

            LinkedListNode<object> newNode5 = new LinkedListNode<object>("the");
            linkedList.AddAfter(newNode4, newNode5);

            LinkedListNode<object> newNode6 = new LinkedListNode<object>("mainly");
            linkedList.AddBefore(linkedListNode2.Previous, newNode6);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            anagram.AddAfter(linkedListNode2.Previous, linkedListNode1);
            anagram.AddBefore(linkedListNode2, linkedListNode2);
            anagram.AddAfter(linkedListNode2, linkedListNode2);
