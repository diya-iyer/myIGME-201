...
namespace Unit2Exam_Q14
{
        ...
        public class Friend
        {
            ...
            // creating a method in order to make a shallow copy of the current Friend object
            public Friend MakeACopy()
            {
    ...
    class Program
        {
            static void Main(string[] args)
            {
                ...
                enemy = friend.MakeACopy(); // turning enemy into a shallow copy of friend
