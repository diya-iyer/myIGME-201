...
namespace PE9_Q2
{
    static class Program
    {
        ...
        static System.Timers.Timer questionTimer = new System.Timers.Timer(8000);
        ...
        start:
            ...
            for (nCntr = 1; nCntr <= nQuestions; ++nCntr)
            {
                ...
                else
                {
                    ...
                    if (bTimedOut)
                    {
                        Console.WriteLine("I'm sorry {0}, you ran out of time, the answer is {1}", myName, nAnswer);
                        bTimedOut = false;
                    }
                    else
                    {
