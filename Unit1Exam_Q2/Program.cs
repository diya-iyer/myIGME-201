...
namespace Unit1Exam_Q2
{
    // Class: Program
    // Author: Diya Iyer
    // Purpose: Hosting the main method that contains a sentencing sorting algorithm
    // Restrictions: None
    class Program
    {
        ...
        // Method: Main 
        // Author: Diya Iyer
        // Purpose: Modifying the existing number sort program in order to alphabetically sort words in a given sentence
        // Restrictions: None
        static void Main(string[] args)

            // changed all double types to strings in order to reflect sentence comparisons
        {
        ...
        start:
            ...
            // a double used for parsing the current array  - no longer needed
            // double nThisNumber;
            ...
            foreach (string sThisWord in sWord)
            {
                ...
                // increment the number of unsorted words
                ++nUnsortedLength;
        ...
        static string FindLowestValue(string[] array)
        {
            ...
            foreach (string thisWord in array)
            {
                ...
                // Checking if the CompareTo function returns a negative value
        ...
        static string FindHighestValue(string[] array)
        {
            ...
            foreach (string thisWord in array)
            {
                ...
                // Checking if the CompareTo function returns a positive value
                if (thisWord.CompareTo(returnVal) > 0)
                {
